...
bool service_cb(robothon2023::GetBoardLocationRequest &req, robothon2023::GetBoardLocationResponse &res) {
...
int main(int argc, char* argv[])
{
    ...
    ros::ServiceServer service = n->advertiseService("/touch_detection", service_cb);
    ROS_ERROR("INIT TOUCH NODE");
