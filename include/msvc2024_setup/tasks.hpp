...
#include <msvc2024_setup/GetTriangles.h>
#include <msvc2024_setup/GetBoardLocation.h>
#include <msvc2024_setup/GetFinished.h>
...
private:
    ...
    bool call_triangles(msvc2024_setup::GetTriangles& srv);
...
public:
    ...
    //BYOD tasks
    bool charging_cable_insert(int slot);
    bool unscrew();
    bool suction();
    bool sphonegrab();
    bool hairdryer();
