...
tasks::tasks(ros::NodeHandle& n)
{
    ...
    triangle_detection_ = n.serviceClient<msvc2024_setup::GetTriangles>("/triangle_detection");
    taskboard_detection_ = n.serviceClient<msvc2024_setup::GetBoardLocation>("/board_detection");
    touch_detection_ = n.serviceClient<msvc2024_setup::GetBoardLocation>("/touch_detection");
    finish_detection_ = n.serviceClient<msvc2024_setup::GetFinished>("/finished_detection");
    ...
    gripper_info_sub_ = n.subscribe("/ur_hardware_interface/robotiq/gripper_infos",100,&tasks::gripper_info_callback,this);
    tcp_position_sub_ = n.subscribe("/ur_hardware_interface/tcp_pose",100,&tasks::tcp_positon_callback,this);
    wrench_sub_ = n.subscribe("/ur_hardware_interface/wrench",100,&tasks::wrench_callback,this);
}
...
void tasks::gripper_info_callback(ur_ros_driver::GripperInfo msg)
{
    gripper_info_ = msg;
}

void tasks::tcp_positon_callback(geometry_msgs::TransformStamped msg)
{
    tcp_position_ = msg;
}

void tasks::wrench_callback(geometry_msgs::WrenchStamped msg)
{
    wrench_ = msg;
}

ur_ros_driver::SetCartTarget tasks::cart_target(std::string target, int mode, double vel, double acc)
{
...
ur_ros_driver::SetForceTarget tasks::force_target(bool IO, array6d free_axis ,array6d wrench, double vel)
{
    vel = vel*vel_multi_;
...
ur_ros_driver::SetJointTarget tasks::joint_target(array6d target, double vel, double acc)
{
...
ur_ros_driver::SetContactTarget tasks::contact_target(array6d speed, double acc)
{
...
ur_ros_driver::SetGripper tasks::gripper_open(double position, double speed, double force)
{
...
ur_ros_driver::SetGripper tasks::gripper_close(double position, double speed, double force)
{
    ur_ros_driver::SetGripper srv;
    srv.request.position = position;
...
void tasks::add_cart_Path_Entry(std::string target, int move_type, double blend, double vel, double acc)
{
...
void tasks::add_joint_Path_Entry(array6d target, int move_type, double blend, double vel, double acc)
{
    ur_ros_driver::PathEntry entry;
...
bool tasks::call_cart_target(ur_ros_driver::SetCartTarget& srv)
{
...
bool tasks::call_force_target(ur_ros_driver::SetForceTarget& srv)
{
...
bool tasks::call_joint_target(ur_ros_driver::SetJointTarget& srv)
{
...
bool tasks::call_contact_target(ur_ros_driver::SetContactTarget& srv)
{
...
bool tasks::call_gripper(ur_ros_driver::SetGripper& srv)
{
...
bool tasks::call_triangles(msvc2024_setup::GetTriangles& srv)
{
...
bool tasks::call_board_detection()
{
...
bool tasks::call_touch_detection()
{
    msvc2024_setup::GetBoardLocation srv;
...
bool tasks::call_finish_detection()
{
    msvc2024_setup::GetFinished srv;
...
bool tasks::call_log(bool IO, std::string filename)
{
...
bool tasks::press_button(std::string color)
{
...
bool tasks::move_slider()
{
    ...
    // msvc2024_setup::GetTriangles srv;
...
bool tasks::move_plug(std::string from, std::string to)
{
...
bool tasks::get_hook(bool bring)
{
    ur_ros_driver::SetGripper g_close = gripper_close();
    ur_ros_driver::SetGripper g_open = gripper_open(50);
    if(!bring) {
...
// bool tasks::get_hook_new(bool bring)
// {
//     ur_ros_driver::SetGripper g_close = gripper_close();
 ...
 * @return false
 */
bool tasks::spiral_force(double start, double stop, int step_c , double step_f, double z_limit, bool dir)
{
    double radius = start;
...
double tasks::pose_distance(geometry_msgs::Transform target)
{
...
bool tasks::charging_cable_insert(int slot) {
